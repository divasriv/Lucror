...
const featureList = [
    ...
    },
    {
        ...
        subtitle: 'The template has Sass available for css. You can Change css by sass'
    },
    {
        icon: <FiDownload/>,
    ...
    },
    {
        ...
        subtitle: 'Bootstrap comfortable is available in lucror. So layout changes is so much easily'
    }
]
...
const singleDemo = [
    ...
    },
    {
        ...
        description: 'It comes with landing page feature. This template you can be used for your Personal useses,  Freelancer, Designer, and Developer etc.',
        label: 'Hot'
    },
    {
    ...
    },
    {
        ...
        description: 'Its a personal portfolio template thats can be used your Personal useses,  Freelancer, Designer, and Developer etc.',
        label: ''
    },
...
const agencyDemo = [
    ...
    },
    {
        ...
        description: 'A World of Opportunities.',
        label: ''
    },
    {
        url: 'creative-portfolio',
                                    ...
                                    <div className="faq-area">
                                        <Accordion className="accodion-style--1" preExpanded={'0'}>
                                            ...
                                            <AccordionItem>
                                                <AccordionItemHeading>
                                                    <AccordionItemButton>
                                                        How can I run lucror react template?
                                                    </AccordionItemButton>
                                                </AccordionItemHeading>
                                                <AccordionItemPanel>
                                                    <p>You can run lucror easily.
