                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="section-title service-style--2 text-center mb--30 mb_sm--0">
                                        <h2>Our Works</h2>
                                        <p>Lucror brings image analytics, conversational Ai, digital Office, RPA, data science or AR/VR to IGNITE business.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                    ...
                    <div className="blog-area ptb--120" data-black-overlay="6">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="section-title service-style--2 text-center mb--30 mb_sm--0">
                                        <h2>Power of the Brand</h2>
                                        <p>Lucror, with game changing brands, brings fire power to business.</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
