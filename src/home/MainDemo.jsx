                        ...
                        <div className="row align-items-end">
                            <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                                <div className="section-title text-left">
                                    <h2>Power of Brands</h2>
                                    <p display-inline>Lucror is associated with game changing business alliances and brands. The brands which are established, futuristic, good management and global thinking and ready to make a difference to the world audience.</p>
                                </div>
                            </div>
                            <div className="col-lg-6 col-md-12 col-sm-12 col-12">
