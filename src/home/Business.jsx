                        ...
                        <div className="row align-items-end">
                            <div className="col-lg-12">
                                <div className="section-title service-style--3 text-center">
                                    <h2 className="title">Power of Brands</h2>
                                    <p>Lucror is associated with game changing business alliances and brands. The brands which are established, futuristic, good management and global thinking and ready to make a difference to the world audience.</p>
                                </div>
                            </div>
                        </div>
